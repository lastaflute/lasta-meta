 ...
 */
public class ActionDocumentAnalyzerTest extends PlainTestCase {
    ...
    public void test_isTargetSuffixResolvedClass_basic() {
        // ## Arrange ##
        ActionDocumentAnalyzer generator = createGenerator();
    ...
    private ActionDocumentAnalyzer createGenerator() {
        return new ActionDocumentAnalyzer(Collections.emptyList(), 0, OptionalThing.empty());
    }
}
