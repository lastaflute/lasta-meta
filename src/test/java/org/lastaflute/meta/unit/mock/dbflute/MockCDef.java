 ...
 */
package org.lastaflute.meta.unit.mock.dbflute;
...
public interface MockCDef extends Classification {
    ...
    public enum Flg implements MockCDef {
        ...
        public ClassificationMeta meta() { return MockCDef.DefMeta.Flg; }
    ...
    public enum MemberStatus implements MockCDef {
        ...
        public Set<String> sisterSet() { return _sisterSet; }
        public Map<String, Object> subItemMap() { return Collections.emptyMap(); }
        public ClassificationMeta meta() { return MockCDef.DefMeta.MemberStatus; }
    ...
    public enum ServiceRank implements MockCDef {
        ...
        public Set<String> sisterSet() { return _sisterSet; }
        public Map<String, Object> subItemMap() { return Collections.emptyMap(); }
        public ClassificationMeta meta() { return MockCDef.DefMeta.ServiceRank; }
    ...
    public enum Region implements MockCDef {
        ...
        public Set<String> sisterSet() { return _sisterSet; }
        public Map<String, Object> subItemMap() { return Collections.emptyMap(); }
        public ClassificationMeta meta() { return MockCDef.DefMeta.Region; }
    ...
    public enum WithdrawalReason implements MockCDef {
        ...
        public Set<String> sisterSet() { return _sisterSet; }
        public Map<String, Object> subItemMap() { return Collections.emptyMap(); }
        public ClassificationMeta meta() { return MockCDef.DefMeta.WithdrawalReason; }
    ...
    public enum ProductCategory implements MockCDef {
        ...
        public Set<String> sisterSet() { return _sisterSet; }
        public Map<String, Object> subItemMap() { return Collections.emptyMap(); }
        public ClassificationMeta meta() { return MockCDef.DefMeta.ProductCategory; }
    ...
    public enum ProductStatus implements MockCDef {
        ...
        public Set<String> sisterSet() { return _sisterSet; }
        public Map<String, Object> subItemMap() { return Collections.emptyMap(); }
        public ClassificationMeta meta() { return MockCDef.DefMeta.ProductStatus; }
    ...
    public enum PaymentMethod implements MockCDef {
        ...
        public Set<String> sisterSet() { return _sisterSet; }
        public Map<String, Object> subItemMap() { return Collections.emptyMap(); }
        public ClassificationMeta meta() { return MockCDef.DefMeta.PaymentMethod; }
    ...
    /**
     * test of confusing name for doc engine
     */
    public enum WhiteConfusingFormatBodying implements MockCDef {
        /** sea */
        ...
        ;
        private static final Map<String, WhiteConfusingFormatBodying> _codeClsMap = new HashMap<String, WhiteConfusingFormatBodying>();
        private static final Map<String, WhiteConfusingFormatBodying> _nameClsMap = new HashMap<String, WhiteConfusingFormatBodying>();
        static {
            for (WhiteConfusingFormatBodying value : values()) {
                _codeClsMap.put(value.code().toLowerCase(), value);
                for (String sister : value.sisterSet()) { _codeClsMap.put(sister.toLowerCase(), value); }
                _nameClsMap.put(value.name().toLowerCase(), value);
            }
        ...
        private String _code; private String _alias; private Set<String> _sisterSet;
        private WhiteConfusingFormatBodying(String code, String alias, String[] sisters)
        { _code = code; _alias = alias; _sisterSet = Collections.unmodifiableSet(new LinkedHashSet<String>(Arrays.asList(sisters))); }
        public String code() { return _code; } public String alias() { return _alias; }
        public Set<String> sisterSet() { return _sisterSet; }
        public Map<String, Object> subItemMap() { return Collections.emptyMap(); }
        public ClassificationMeta meta() { return MockCDef.DefMeta.WhiteConfusingFormatBodying; }
         ...
         * @return The optional classification corresponding to the code. (NotNull, EmptyAllowed: if not found, returns empty)
         */
        public static OptionalThing<WhiteConfusingFormatBodying> of(Object code) {
            if (code == null) { return OptionalThing.ofNullable(null, () -> { throw new ClassificationNotFoundException("null code specified"); }); }
            if (code instanceof WhiteConfusingFormatBodying) { return OptionalThing.of((WhiteConfusingFormatBodying)code); }
            if (code instanceof OptionalThing<?>) { return of(((OptionalThing<?>)code).orElse(null)); }
            return OptionalThing.ofNullable(_codeClsMap.get(code.toString().toLowerCase()), () ->{
                throw new ClassificationNotFoundException("Unknown classification code: " + code);
            });
         ...
         * @return The optional classification corresponding to the name. (NotNull, EmptyAllowed: if not found, returns empty)
         */
        public static OptionalThing<WhiteConfusingFormatBodying> byName(String name) {
            if (name == null) { throw new IllegalArgumentException("The argument 'name' should not be null."); }
            return OptionalThing.ofNullable(_nameClsMap.get(name.toLowerCase()), () ->{
                throw new ClassificationNotFoundException("Unknown classification name: " + name);
            });
         ...
         * @return The instance of the corresponding classification to the code. (NullAllowed: if not found, returns null)
         */
        public static WhiteConfusingFormatBodying codeOf(Object code) {
            if (code == null) { return null; }
            if (code instanceof WhiteConfusingFormatBodying) { return (WhiteConfusingFormatBodying)code; }
            return _codeClsMap.get(code.toString().toLowerCase());
        }
         ...
         * @return The instance of the corresponding classification to the name. (NullAllowed: if not found, returns null)
         */
        public static WhiteConfusingFormatBodying nameOf(String name) {
            if (name == null) { return null; }
            try { return valueOf(name); } catch (RuntimeException ignored) { return null; }
        }
         ...
         * @return The snapshot list of all classification elements. (NotNull)
         */
        public static List<WhiteConfusingFormatBodying> listAll() {
            return new ArrayList<WhiteConfusingFormatBodying>(Arrays.asList(values()));
        }
         ...
         * @return The snapshot list of classification elements in the group. (NotNull, EmptyAllowed: if not found, throws exception)
         */
        public static List<WhiteConfusingFormatBodying> listByGroup(String groupName) {
            if (groupName == null) { throw new IllegalArgumentException("The argument 'groupName' should not be null."); }
            throw new ClassificationNotFoundException("Unknown classification group: WhiteConfusingFormatBodying." + groupName);
        }
         ...
         * @return The snapshot list of classification elements in the code list. (NotNull, EmptyAllowed: when empty specified)
         */
        public static List<WhiteConfusingFormatBodying> listOf(Collection<String> codeList) {
            if (codeList == null) { throw new IllegalArgumentException("The argument 'codeList' should not be null."); }
            List<WhiteConfusingFormatBodying> clsList = new ArrayList<WhiteConfusingFormatBodying>(codeList.size());
            for (String code : codeList) { clsList.add(of(code).get()); }
            return clsList;
        }
         ...
         * @return The snapshot list of classification elements in the group. (NotNull, EmptyAllowed: if the group is not found)
         */
        public static List<WhiteConfusingFormatBodying> groupOf(String groupName) {
            return new ArrayList<WhiteConfusingFormatBodying>(4);
        }
    ...
    public enum DefMeta implements ClassificationMeta {
        ...
        public OptionalThing<? extends Classification> of(Object code) {
            if (Flg.name().equals(name())) { return MockCDef.Flg.of(code); }
            if (MemberStatus.name().equals(name())) { return MockCDef.MemberStatus.of(code); }
            if (ServiceRank.name().equals(name())) { return MockCDef.ServiceRank.of(code); }
            if (Region.name().equals(name())) { return MockCDef.Region.of(code); }
            if (WithdrawalReason.name().equals(name())) { return MockCDef.WithdrawalReason.of(code); }
            if (ProductCategory.name().equals(name())) { return MockCDef.ProductCategory.of(code); }
            if (ProductStatus.name().equals(name())) { return MockCDef.ProductStatus.of(code); }
            if (PaymentMethod.name().equals(name())) { return MockCDef.PaymentMethod.of(code); }
            if (WhiteConfusingFormatBodying.name().equals(name())) { return MockCDef.WhiteConfusingFormatBodying.of(code); }
            throw new IllegalStateException("Unknown definition: " + this); // basically unreachable
        }

        public OptionalThing<? extends Classification> byName(String name) {
            if (Flg.name().equals(name())) { return MockCDef.Flg.byName(name); }
            if (MemberStatus.name().equals(name())) { return MockCDef.MemberStatus.byName(name); }
            if (ServiceRank.name().equals(name())) { return MockCDef.ServiceRank.byName(name); }
            if (Region.name().equals(name())) { return MockCDef.Region.byName(name); }
            if (WithdrawalReason.name().equals(name())) { return MockCDef.WithdrawalReason.byName(name); }
            if (ProductCategory.name().equals(name())) { return MockCDef.ProductCategory.byName(name); }
            if (ProductStatus.name().equals(name())) { return MockCDef.ProductStatus.byName(name); }
            if (PaymentMethod.name().equals(name())) { return MockCDef.PaymentMethod.byName(name); }
            if (WhiteConfusingFormatBodying.name().equals(name())) { return MockCDef.WhiteConfusingFormatBodying.byName(name); }
            throw new IllegalStateException("Unknown definition: " + this); // basically unreachable
        }

        public Classification codeOf(Object code) { // null if not found, old style so use of(code)
            if (Flg.name().equals(name())) { return MockCDef.Flg.codeOf(code); }
            if (MemberStatus.name().equals(name())) { return MockCDef.MemberStatus.codeOf(code); }
            if (ServiceRank.name().equals(name())) { return MockCDef.ServiceRank.codeOf(code); }
            if (Region.name().equals(name())) { return MockCDef.Region.codeOf(code); }
            if (WithdrawalReason.name().equals(name())) { return MockCDef.WithdrawalReason.codeOf(code); }
            if (ProductCategory.name().equals(name())) { return MockCDef.ProductCategory.codeOf(code); }
            if (ProductStatus.name().equals(name())) { return MockCDef.ProductStatus.codeOf(code); }
            if (PaymentMethod.name().equals(name())) { return MockCDef.PaymentMethod.codeOf(code); }
            if (WhiteConfusingFormatBodying.name().equals(name())) { return MockCDef.WhiteConfusingFormatBodying.codeOf(code); }
            throw new IllegalStateException("Unknown definition: " + this); // basically unreachable
        }

        public Classification nameOf(String name) { // null if not found, old style so use byName(name)
            if (Flg.name().equals(name())) { return MockCDef.Flg.valueOf(name); }
            if (MemberStatus.name().equals(name())) { return MockCDef.MemberStatus.valueOf(name); }
            if (ServiceRank.name().equals(name())) { return MockCDef.ServiceRank.valueOf(name); }
            if (Region.name().equals(name())) { return MockCDef.Region.valueOf(name); }
            if (WithdrawalReason.name().equals(name())) { return MockCDef.WithdrawalReason.valueOf(name); }
            if (ProductCategory.name().equals(name())) { return MockCDef.ProductCategory.valueOf(name); }
            if (ProductStatus.name().equals(name())) { return MockCDef.ProductStatus.valueOf(name); }
            if (PaymentMethod.name().equals(name())) { return MockCDef.PaymentMethod.valueOf(name); }
            if (WhiteConfusingFormatBodying.name().equals(name())) { return MockCDef.WhiteConfusingFormatBodying.valueOf(name); }
            throw new IllegalStateException("Unknown definition: " + this); // basically unreachable
        }

        public List<Classification> listAll() {
            if (Flg.name().equals(name())) { return toClsList(MockCDef.Flg.listAll()); }
            if (MemberStatus.name().equals(name())) { return toClsList(MockCDef.MemberStatus.listAll()); }
            if (ServiceRank.name().equals(name())) { return toClsList(MockCDef.ServiceRank.listAll()); }
            if (Region.name().equals(name())) { return toClsList(MockCDef.Region.listAll()); }
            if (WithdrawalReason.name().equals(name())) { return toClsList(MockCDef.WithdrawalReason.listAll()); }
            if (ProductCategory.name().equals(name())) { return toClsList(MockCDef.ProductCategory.listAll()); }
            if (ProductStatus.name().equals(name())) { return toClsList(MockCDef.ProductStatus.listAll()); }
            if (PaymentMethod.name().equals(name())) { return toClsList(MockCDef.PaymentMethod.listAll()); }
            if (WhiteConfusingFormatBodying.name().equals(name())) { return toClsList(MockCDef.WhiteConfusingFormatBodying.listAll()); }
            throw new IllegalStateException("Unknown definition: " + this); // basically unreachable
        }

        public List<Classification> listByGroup(String groupName) { // exception if not found
            if (Flg.name().equals(name())) { return toClsList(MockCDef.Flg.listByGroup(groupName)); }
            if (MemberStatus.name().equals(name())) { return toClsList(MockCDef.MemberStatus.listByGroup(groupName)); }
            if (ServiceRank.name().equals(name())) { return toClsList(MockCDef.ServiceRank.listByGroup(groupName)); }
            if (Region.name().equals(name())) { return toClsList(MockCDef.Region.listByGroup(groupName)); }
            if (WithdrawalReason.name().equals(name())) { return toClsList(MockCDef.WithdrawalReason.listByGroup(groupName)); }
            if (ProductCategory.name().equals(name())) { return toClsList(MockCDef.ProductCategory.listByGroup(groupName)); }
            if (ProductStatus.name().equals(name())) { return toClsList(MockCDef.ProductStatus.listByGroup(groupName)); }
            if (PaymentMethod.name().equals(name())) { return toClsList(MockCDef.PaymentMethod.listByGroup(groupName)); }
            if (WhiteConfusingFormatBodying.name().equals(name())) { return toClsList(MockCDef.WhiteConfusingFormatBodying.listByGroup(groupName)); }
            throw new IllegalStateException("Unknown definition: " + this); // basically unreachable
        }

        public List<Classification> listOf(Collection<String> codeList) {
            if (Flg.name().equals(name())) { return toClsList(MockCDef.Flg.listOf(codeList)); }
            if (MemberStatus.name().equals(name())) { return toClsList(MockCDef.MemberStatus.listOf(codeList)); }
            if (ServiceRank.name().equals(name())) { return toClsList(MockCDef.ServiceRank.listOf(codeList)); }
            if (Region.name().equals(name())) { return toClsList(MockCDef.Region.listOf(codeList)); }
            if (WithdrawalReason.name().equals(name())) { return toClsList(MockCDef.WithdrawalReason.listOf(codeList)); }
            if (ProductCategory.name().equals(name())) { return toClsList(MockCDef.ProductCategory.listOf(codeList)); }
            if (ProductStatus.name().equals(name())) { return toClsList(MockCDef.ProductStatus.listOf(codeList)); }
            if (PaymentMethod.name().equals(name())) { return toClsList(MockCDef.PaymentMethod.listOf(codeList)); }
            if (WhiteConfusingFormatBodying.name().equals(name())) { return toClsList(MockCDef.WhiteConfusingFormatBodying.listOf(codeList)); }
            throw new IllegalStateException("Unknown definition: " + this); // basically unreachable
        }

        public List<Classification> groupOf(String groupName) { // old style
            if (Flg.name().equals(name())) { return toClsList(MockCDef.Flg.groupOf(groupName)); }
            if (MemberStatus.name().equals(name())) { return toClsList(MockCDef.MemberStatus.groupOf(groupName)); }
            if (ServiceRank.name().equals(name())) { return toClsList(MockCDef.ServiceRank.groupOf(groupName)); }
            if (Region.name().equals(name())) { return toClsList(MockCDef.Region.groupOf(groupName)); }
            if (WithdrawalReason.name().equals(name())) { return toClsList(MockCDef.WithdrawalReason.groupOf(groupName)); }
            if (ProductCategory.name().equals(name())) { return toClsList(MockCDef.ProductCategory.groupOf(groupName)); }
            if (ProductStatus.name().equals(name())) { return toClsList(MockCDef.ProductStatus.groupOf(groupName)); }
            if (PaymentMethod.name().equals(name())) { return toClsList(MockCDef.PaymentMethod.groupOf(groupName)); }
            if (WhiteConfusingFormatBodying.name().equals(name())) { return toClsList(MockCDef.WhiteConfusingFormatBodying.groupOf(groupName)); }
            throw new IllegalStateException("Unknown definition: " + this); // basically unreachable
        }
        ...
        public ClassificationCodeType codeType() {
            ...
            if (WhiteConfusingFormatBodying.name().equals(name())) { return ClassificationCodeType.String; }
        ...
        public ClassificationUndefinedHandlingType undefinedHandlingType() {
            ...
            if (WhiteConfusingFormatBodying.name().equals(name())) { return ClassificationUndefinedHandlingType.EXCEPTION; }
        ...
        public static OptionalThing<MockCDef.DefMeta> find(String classificationName) { // instead of valueOf()
            ...
            if (Flg.name().equalsIgnoreCase(classificationName)) { return OptionalThing.of(MockCDef.DefMeta.Flg); }
            if (MemberStatus.name().equalsIgnoreCase(classificationName)) { return OptionalThing.of(MockCDef.DefMeta.MemberStatus); }
            if (ServiceRank.name().equalsIgnoreCase(classificationName)) { return OptionalThing.of(MockCDef.DefMeta.ServiceRank); }
            if (Region.name().equalsIgnoreCase(classificationName)) { return OptionalThing.of(MockCDef.DefMeta.Region); }
            if (WithdrawalReason.name().equalsIgnoreCase(classificationName)) { return OptionalThing.of(MockCDef.DefMeta.WithdrawalReason); }
            if (ProductCategory.name().equalsIgnoreCase(classificationName)) { return OptionalThing.of(MockCDef.DefMeta.ProductCategory); }
            if (ProductStatus.name().equalsIgnoreCase(classificationName)) { return OptionalThing.of(MockCDef.DefMeta.ProductStatus); }
            if (PaymentMethod.name().equalsIgnoreCase(classificationName)) { return OptionalThing.of(MockCDef.DefMeta.PaymentMethod); }
            if (WhiteConfusingFormatBodying.name().equalsIgnoreCase(classificationName)) { return OptionalThing.of(MockCDef.DefMeta.WhiteConfusingFormatBodying); }
        ...
        public static MockCDef.DefMeta meta(String classificationName) { // old style so use find(name)
            if (classificationName == null) { throw new IllegalArgumentException("The argument 'classificationName' should not be null."); }
            if (Flg.name().equalsIgnoreCase(classificationName)) { return MockCDef.DefMeta.Flg; }
            if (MemberStatus.name().equalsIgnoreCase(classificationName)) { return MockCDef.DefMeta.MemberStatus; }
            if (ServiceRank.name().equalsIgnoreCase(classificationName)) { return MockCDef.DefMeta.ServiceRank; }
            if (Region.name().equalsIgnoreCase(classificationName)) { return MockCDef.DefMeta.Region; }
            if (WithdrawalReason.name().equalsIgnoreCase(classificationName)) { return MockCDef.DefMeta.WithdrawalReason; }
            if (ProductCategory.name().equalsIgnoreCase(classificationName)) { return MockCDef.DefMeta.ProductCategory; }
            if (ProductStatus.name().equalsIgnoreCase(classificationName)) { return MockCDef.DefMeta.ProductStatus; }
            if (PaymentMethod.name().equalsIgnoreCase(classificationName)) { return MockCDef.DefMeta.PaymentMethod; }
            if (WhiteConfusingFormatBodying.name().equalsIgnoreCase(classificationName)) { return MockCDef.DefMeta.WhiteConfusingFormatBodying; }
