 ...
 */
package org.lastaflute.meta.generator.annotation;
 ...
 */
public class MetaAnnotationAnalyzer {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public MetaAnnotationAnalyzer(MetaTypeNameAdjuster metaTypeNameAdjuster) {
    ...
    //                                                                             Analyze
    //                                                                             =======
    public List<String> analyzeAnnotationList(List<Annotation> annotationList) {
